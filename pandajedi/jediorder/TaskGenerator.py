...
from pandajedi.jedigen.TaskGeneratorBase import TaskGeneratorBase
...
class TaskGenerator(FactoryBase[TaskGeneratorBase]):
    # constructor
    ...
    def doGenerate(self, taskSpec: JediTaskSpec, taskParamMap: dict[str, Any], **varMap: Any) -> Interaction.StatusCode:
        return self.requireImpl(taskSpec.vo, taskSpec.prodSourceLabel).doGenerate(taskSpec, taskParamMap, **varMap)
