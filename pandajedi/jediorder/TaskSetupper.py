...
from pandajedi.jedisetup.TaskSetupperBase import TaskSetupperBase
...
class TaskSetupper(FactoryBase[TaskSetupperBase]):
    # constructor
    ...
    def doSetup(self, taskSpec: JediTaskSpec, datasetToRegister: list[int | Null], pandaJobs: list[JobSpec]) -> Interaction.StatusCode:
        return self.requireImpl(taskSpec.vo, taskSpec.prodSourceLabel).doSetup(taskSpec, datasetToRegister, pandaJobs)
